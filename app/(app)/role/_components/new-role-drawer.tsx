"use client";
import { Modal, Button, TextField, Label, Input, Card, useOverlayState } from "@heroui/react";
import { useForm, Controller, useWatch } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { useMemo } from "react";
import { z } from "zod";
import { MENU, RESOURCE_PERMISSIONS } from "@/constants";
...
const NewRole = () => {
  ...
  const assignAll = () => {
    ...
    formInfo.setValue("permissions", allPermissions);
  };

  const unassignAll = () => {
    formInfo.setValue("permissions", {});
  };
        ...
        <Modal.Backdrop isDismissable={false}>
          <Modal.Container size="cover">
            <Modal.Dialog>
              <Modal.CloseTrigger />
              <Modal.Header>
                <Modal.Heading>Add new role</Modal.Heading>
              </Modal.Header>
              <Modal.Body>
                <form
                  key="productForm"
              ...
              <Modal.Footer>
                ...
                <Button type="submit" form="new-role-form" className="bg-emerald-500">
                  Save
                </Button>
              </Modal.Footer>
            </Modal.Dialog>
